...
<% 
      ...
      if(session.getAttribute("user") == null){
		...
		if(request.getAttribute("orders")== null){
			session.setAttribute("err_mssg", "Cannot Book At This Moment! Please try Again:) ");
			response.sendRedirect("homeValidate.htm");
		}
                 			...
                 			<div class="jumbotron" >
                 						<div class="row mt-2">
                 								...
                 								<div class="col-10 mt-2">
                 									<div class="text-dark">Ticket No :  &nbsp<%=ord.getTicketId() %></div>
                 								</div>                 									
                 						</div>
										...
										<div class="row mt-2" >
                 								...
                 								<div class="col-10 mt-2 float-right">
                 									<a href=""></a> <div class="text-dark">Total Price with 10.00% tax:  $&nbsp;&nbsp<%=ord.getPrice() %></div>
                 								</div>                 									
                 						</div>
                 						...
                 						<div class="row mt-2">
                 								...
                 								<div class="col-10 mt-2 float-right">
                 									...
                 									<a href="homeValidate.htm"> <button class="btn btn-danger ">Go Home</button></a>
                 									<a href="contact_Us.jsp"> <button class="btn btn-info ">Contact Us</button></a>
                 								</div>  
                 								<div class="col-10 mt-2 float-right">
