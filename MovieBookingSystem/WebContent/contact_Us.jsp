    ...
    <div id="form-main">
        <div id="form-div">
          <form class="montform" id="reused_form" action="prep_log_form.htm">
            ...
            <p class="text">
              <textarea  style="font-size: large; width:57vh; padding: 20px ;" name="message" class="feedback-input" id="comment" placeholder="&#9829; Please leave any comments to this website, we would love to hear from you!"></textarea>
            </p>
