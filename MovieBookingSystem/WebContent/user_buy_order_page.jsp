...
<div class="container-fluid">
				...
				<table class="table  table-striped ">
					<thead class="table-dark">
						<tr>
							...
							<th class="align-middle">Screen No.</th>
					...
					<% List<Orders> li = (List<Orders>)request.getAttribute("mList");
							for(Orders f : li){
		  			 ...
		  			 %>
						<tr style="color:white;">
							...
							<td class="align-middle"><%= f.getShows().getMovie().getMovieName() %></td>
							<td class="align-middle"><%= f.getOrderDate() %></td>
							<td class="align-middle"><%= f.getShows().getHall().getHallId() %></td>
							<td class="align-middle"><%= f.getShows().getMovie().getLanguage() %></td>
   ...
   <footer class="page-footer font-small bg-dark text-light fixed-bottom">
      ...
      <div class="footer-copyright text-center">
        © 2024 Copyright:
        <a href="error_page.jsp"> Contact Me</a><span><a href="contact_Us.jsp">&nbspContact Us</a></span>
      </div>
      <!-- Copyright -->
    </footer>
</body>
