...
<%@ page import="com.bookmovie.pojo.Movie"%>
<%@ page import="com.bookmovie.pojo.User"%>
...
<body>
    <nav class="navbar navbar-expand fixed-top text-light navbar-dark bg-dark justify-content-between">
        ...
        <div class="nav navbar-nav">
            ...
            <a class="nav-item nav-link" href="#"><button class="btn btn-outline-danger">Hi&nbsp<%= user.getuFname() %></button></a>
    ...
    <div class="container-fluid">
        <div class="row content">
            <div class="col-sm-12 jumbotron p-3 text-light" style="background-color:rgba(26, 26, 26, 0.6);">
                <h3 class="text-center"><b>Movies Available</b></h3>
                <div class="container">
                    <div class="row">
                ...
                <div class="jumbotron p-1" style="background-color:rgb(255, 255, 255, 0.8);">
                    <div class="row p-4 mx-2">
                        <div class="col-md-4 col-sm-3 col-4">
                            <div class="card">
                                <iframe width="100%" height="100%" src="<%= i.getUrlV() %>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="col-md-8 col-sm-9 col-8">
                            ...
                            <div class="row mt-1 p-0">
                                ...
                                <div class="col-4">
                                    <a href="prep_show.htm?movie_id=<%= i.getMovieId() %>&mname=<%= i.getMovieName() %>&urlV=<%= i.getUrlV() %>">
                                        <button type="button" class="btn btn-outline-danger float-right" id="btn0" data-target="#myModal">Book Now</button>
                                    </a>
                                </div>     
                            </div>
                        </div>
    ...
    <footer class="page-footer font-small bg-dark text-light fixed-bottom">
        ...
        <div class="footer-copyright text-center">
            © 2024 Copyright:
            <a href="error_page.jsp"> </a><span><a href="contact_Us.jsp">&nbspContact Us</a></span>
        </div>
    </footer>
</body>
</html>
